...
const STATUS_COLOR_PALETTE: {
  ...
  '1': { BG_COLOR: '#E3E2E0', FONT_COLOR: '#595754', DOT_COLOR: '#91918E', TEXT: '시작 전' }, // 시작 전
  '2': { BG_COLOR: '#D3E5EF', FONT_COLOR: '#193347', DOT_COLOR: '#5B97BD', TEXT: '진행 중' }, // 진행 중
  '3': { BG_COLOR: '#E9FFEF', FONT_COLOR: '#409261', DOT_COLOR: '#409261', TEXT: '완료' }, // 완료
};
