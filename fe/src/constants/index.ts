...
export const MANUAL_CONSTANTS: {
  ...
  FEATURE: [
    ...
    { name: '기능명', key: 'issueName', fixedWidth: '200px', celType: 'TEXT', iconName: 'current-state-title' },
    ...
    { name: '상세 기능', key: 'description', fixedWidth: '312px', celType: 'TEXT', iconName: 'current-state-title' },
    { name: '진행 상태', key: 'state', fixedWidth: '120px', celType: 'SELECT', iconName: 'current-state-title' },
